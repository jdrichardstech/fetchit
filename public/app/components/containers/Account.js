    ...
    return (
      <div>
        <section
          id="content"
          style={{
            backgroundImage: 'url("images/account_bkg.jpg")',
            minHeight: 900
          }}
        >
          <div className="content-wrap" style={{ padding: 0 }}>
            <div className="container clearfix">
              <h1>
                <span style={{ color: '#fff', textShadow: '1px 1px #000' }}>
              ...
              <div className="tabs tabs-bordered clearfix" id="tab-2">
                <ul
                  ...
                  style={{ background: '#fef1df', border: 'none' }}
                >
                  <li style={{ border: 'none' }}>
                    <a href="#tabs-7" style={{ backgroundColor: '#fef1df' }}>
                      Place Order
                    </a>
                  </li>
                  <li style={{ border: 'none' }} className="hidden-phone">
                    <a href="#tabs-8" style={{ backgroundColor: '#fef1df' }}>
                      Your Orders
                    </a>
                  </li>
                  <li style={{ border: 'none' }}>
                    <a href="#tabs-6" style={{ backgroundColor: '#fef1df' }}>
                      Account
                    </a>
                  </li>
                </ul>
                ...
                <div className="tab-container" style={{ background: '#fff' }}>
                      ...
                      >
                        ...
                        >
                          ...
                          <div className="col_full">
                            ...
                            <textarea
                              placeholder="office supplies, food, coffee, store items, etc."
                              onChange={this.updateCurrentOrder}
                              id="order"
                              className="form-control"
                              value={this.state.currentOrder.order}
                            ></textarea>
                          </div>
                  ...
                  <div className="tab-content clearfix" id="tabs-8">
                    <table className="table">
                      ...
                      <tbody style={{ color: '#555' }}>{orderList}</tbody>
                    </table>
                  </div>
                </div>
              </div>
