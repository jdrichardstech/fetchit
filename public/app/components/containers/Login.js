...
var Login = React.createClass({
  ...
  refresh: function() {
    ...
    if (this.state.currentUser.id != null) window.location.href = '/account';
  },
      ...
      <div>
        <section id="content">
          <div className="content-wrap nopadding">
            <div
              className="section nopadding nomargin"
              style={{
                width: 100 + '%',
                height: 100 + '%',
                position: 'absolute',
                left: 0,
                top: 0,
                background: 'url("/images/loginbackgroundlogo.jpg")'
              }}
            ></div>
            <div className="section nobg full-screen nopadding nomargin">
              <div className="container vertical-middle divcenter clearfix">
                ...
                <br />
                <div
                  className="panel panel-default divcenter noradius noborder"
                  style={{ maxWidth: 400, background: '#F9F9F9' }}
                >
                  <div className="row center" style={{ padding: 40 }}>
                    ...
                    >
                      ...
                      <div className="col_full nobottommargin center">
                        <button
                          onClick={this.login}
                          className="button button-3d button-red nomargin"
                ...
                <div className="row center dark" style={{ marginBottom: 44 }}>
                  <small>
                    Copyrights &copy; All Rights Reserved by FETCH Inc.
                  </small>
                </div>
              </div>
            </div>
